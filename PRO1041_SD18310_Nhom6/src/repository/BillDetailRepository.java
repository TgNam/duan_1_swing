    ...
    public ArrayList<BillDetail> getBill_all(String id) {
        ...
        try {
            String sql = "select \n"
                    ...
                    + "db_levents.bill_detail.updated_at, db_levents.product.product_price\n"
                    + "from db_levents.bill_detail\n"
                    + "left join db_levents.product_detail on db_levents.bill_detail.product_detail_id = db_levents.product_detail.id\n"
                    ...
                    + "inner join db_levents.product on db_levents.product_detail.product_id = db_levents.product.id\n"
...
//              String id = rs.getString(11);
              ...
              ProductDetail pdt = new ProductDetail(color, product, size);
