...
public class ImageDatabaseExample {
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            ...
            String imagePath = "C:\\Users\\thiet\\OneDrive\\Hình ảnh\\Ảnh chụp màn hình\\Screenshot 2023-11-21 221104.png"; // Đường dẫn đến file ảnh
            byte[] imageData = readImageFile(imagePath);

            String description = "";

            String insertQuery = "update db_levents.product set image_type = ?, image_data = ? where id = '13';";
